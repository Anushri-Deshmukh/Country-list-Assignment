      ...
      {countries?.map((country, index) => (
        <div className="detail-container" key={index}>
          ...
          <article className="detail-info-position">
            ...
            <p>
              Population:{" "}
              <span>{country?.population.toLocaleString("en-US") || "__"}</span>
            </p>
            <p>
              Region: <span>{country?.region || "__"}</span>
            </p>
            <p>
              Subregion: <span>{country?.subregion || "__"}</span>
            </p>
            <p>
              Capital: <span>{country?.capital || "__"}</span>
            </p>
            <p>
              Currencies:{" "}
              <span>
                {Object.entries(country?.currencies).map(
                  ([code, currency], index) => currency.name
                )}
              </span>
            </p>
            <p>
